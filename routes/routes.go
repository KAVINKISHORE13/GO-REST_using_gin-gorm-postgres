...
import (
	...
	"github.com/kavinkishore13/go-rest_using_gin-gorm-postgres/controller"
	"github.com/kavinkishore13/go-rest_using_gin-gorm-postgres/dal"
	"github.com/kavinkishore13/go-rest_using_gin-gorm-postgres/service"
	"gorm.io/gorm"
)
